      ...
      >
        {(styles) => (
          <animated.div style={styles} ref={alertRef}>
            <SuccessAlert text="User data updated successfully!" />
          </animated.div>
        )}
      </Spring>
      ...
      <div className="flex flex-col items-center px-6 pt-10">
        <form className="w-[550px]" onSubmit={handleSubmit(onSubmit)}>
          <div className="flex flex-col items-center mb-10">
            <div className="w-7 h-7 ml-36 text-gray-500 cursor-pointer hover:scale-110 active:scale-100 duration-300">
              {avatarUrl && <XCircleIcon onClick={deleteAvatar} />}
            </div>
